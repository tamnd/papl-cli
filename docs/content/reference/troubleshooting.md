...
Most of these come down to network reality or how papl serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

papl rate-limits like any public site. papl already paces
...
Where a surface is gated, papl reads a cookie or token you supply
...
`papl`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what papl actually did
